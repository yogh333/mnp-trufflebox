...
contract("Board", async (accounts) => {
  ...
  describe.only("B. Test of the requestRandomNumber function", () => {
      ...
      it("3. Pass if the LINK balance of the contract has enough fees", async function () {
          ...
          await BoardInstance.register(new BN(0), new BN(1));
          await VRFConsumerBaseInstance.faucet(BoardInstance.address,web3.utils.toBN(new BN(10).mul(new BN(10).pow(new BN(28)))));
    ...
    describe("D. Test of the function play", () =>  {
        ...
        xit("12. We test the modulos, the bounds related to the movement of the pawn"), async() => {
